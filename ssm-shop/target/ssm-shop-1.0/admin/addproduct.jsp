    ...
    <script type="text/javascript">
        function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
           $.ajaxFileUpload({
			   ...
			   fileElementId: 'pimage',   //上传文件的id,在<input type="" id="">中定义
			   dataType:'json',
			   success:function (obj) {  //obj为返回的图片对象
                  //创建图片标签
				   var imgObj=$("<img>");                     //jQuery创建某类型标签的方法
				   imgObj.attr("src","${pageContext.request.contextPath}/image_big/"+obj.imgurl);  //.attr方式设置属性
